 ...
 */
package mx.myhybris.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(MyhybrisFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MyhybrisFulfilmentProcessConstants.PARENT_PROCESS);
