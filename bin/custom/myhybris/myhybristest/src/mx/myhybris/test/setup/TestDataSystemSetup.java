 ...
 */
package mx.myhybris.test.setup;
...
import mx.myhybris.test.constants.MyhybrisTestConstants;
import mx.myhybris.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MyhybrisTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/myhybristest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/myhybristest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/myhybristest/import/cstickets.impex");
			...
			importImpexFile(context, "/myhybristest/import/csquotes.impex");
		}
	}
}
